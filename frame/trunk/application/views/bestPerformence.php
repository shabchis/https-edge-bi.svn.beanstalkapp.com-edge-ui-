    ...
    <div id="wrapper">
       ...
       <li>
            <div class="description">
                <p>
            		<b> Best performance </b>Detected on <span class="campaignName"> AdWords > 2tier - US – Search > Branding.</span>
                    <div class="clear"></div>
           		 	Incurred Win: <span class="win">$100.</span>
                </p>
                 </div>
...
#recommendations li{
background:url('./assets/img/green_arrow_03.jpg') no-repeat top left;
